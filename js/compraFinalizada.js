...
let valorDeCompra = localStorage.getItem("ValorDeCompra");
...
html = `<div class="animate__animated animate__jackInTheBox ticket__container">
            ...
            <h3>¡El pago de <b>$${valorDeCompra} </b> ya fue aprobado con la tarjeta <b>${numeroDeTarjeta} </b>¡Que los disfrutes!</h3>
